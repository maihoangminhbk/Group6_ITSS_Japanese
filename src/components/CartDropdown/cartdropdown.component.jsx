...
import { removeAll } from "../../redux/cart/cart.reducer";

const CardDropdown = ({ cartItem, history, dispatch }) => (
  <div className="cart-dropdown">
    <div className="cart-items">
      {cartItem.length ? (
        cartItem.map((cart) => <CartInIcon key={cart.id} item={cart} />)
      ) : (
    ...
    <CustomButton onClick={() => {dispatch(removeAll())}}>Clear All Item</CustomButton>
  </div>
);
